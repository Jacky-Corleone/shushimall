 ...
 *
 */
public class CentralPurchasingDTO implements Serializable {
    ...
    // 活动详情
    private List<CentralPurchasingDetails> details;
	...
	public List<CentralPurchasingDetails> getDetails() {
		return details;
	}
	public void setDetails(List<CentralPurchasingDetails> details) {
