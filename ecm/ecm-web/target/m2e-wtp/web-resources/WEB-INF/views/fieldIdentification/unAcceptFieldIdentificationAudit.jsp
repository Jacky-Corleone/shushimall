...
<head>
	...
	<script type="text/javascript">
		...
		//受理审核
	    function doAccept(acceptPrimaryKey){
	    	//设置表单主键字段值
	        $("#acceptPrimaryKey").val(acceptPrimaryKey);
	      //表单提交
            $('#acceptForm').ajaxSubmit({
                type:'post',
                dataType:'json',
                success:function(data){
	                if(data.success && data.auditStatus==1){
	                    $.jBox.info("受理成功");
	                }
...
<body>
	<div class="content sub-content">
	    <div class="content-body content-sub-body">
	        <form id="queryForm" method="post" action="${ctx}/fieldIdentificationAudit/unAccept"  >
			...
			<table id="treeTable" class="table table-striped table-bordered table-condensed">
			    ...
			    <tr id="tr${item.id}" >
			        ...
			        <td>未受理</td>
			        <td>
			        	<a href="#" onclick="doAccept(${item.id})">受理&nbsp;</a>
						<%-- <a href="#" onclick="showApprove(${item.id})">审核&nbsp;</a> --%>
			         	<a href="#" onclick="showUpload(${item.userId},${item.extendId},'unAccept')">上传&nbsp;</a>
    ...
    <div class="modal hide fade">
        <!-- 表单Form开始 -->
        <form id="acceptForm" action="${ctx}/fieldIdentificationAudit/modifyAuditStatus">
	        <input type="hidden" name="primaryKey" id="acceptPrimaryKey">
