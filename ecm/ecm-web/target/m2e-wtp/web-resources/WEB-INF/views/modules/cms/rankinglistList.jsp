...
<head>
	...
	<script type="text/javascript">
		...
		function previewRankingList(id){
			window.location.href="${ctx}/cms/rankingList/preview?id="+id;
		}
		function publishRankingList(id){
			window.location.href="${ctx}/cms/rankingList/publish?id="+id;
		}
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="rankingList">
			<tr>
				...
				<td>
					<a href="javascript:previewRankingList('${rankingList.id}');">预览  </a>
					<a href="javascript:publishRankingList('${rankingList.id}');">发布 </a>
