...
<body>
	...
	<form:form id="searchForm" modelAttribute="article" action="${ctx}/cms/cms/tagsMange/selectList" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead><tr><th style="text-align:center;">选择</th><th>标签名</th><th>类型</th><th>父节点</th></tr></thead>
		<tbody>
		<c:forEach items="${page.list}" var="article">
			<tr>
				<td style="text-align:center;"><input type="checkbox" name="id" value="${article.id}" /></td>
