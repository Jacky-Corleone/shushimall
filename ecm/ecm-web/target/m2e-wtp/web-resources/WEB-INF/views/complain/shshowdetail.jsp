...
<div class="content sub-content">
    <div class="content-body content-sub-body" style="margin-left:3%;">
        <div class="y-box">
            ...
            <div class="z-box">
                <h3 class="h3">售后进度</h3></td>
                <div class="z-box2">
                    <div class="returnStep">
                        <ul>
                            <li class="first <c:if test="${map.step=='step1'}">current</c:if>">选择申请售后货品</li>
                            <li class="second <c:if test="${map.step=='step2'}">current</c:if>">填写售后原因、金额</li>
                            <li class="third <c:if test="${map.step=='step3'}">current</c:if>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;售后处理</li>
                            <li class="forth <c:if test="${map.step=='step4'}">current</c:if>">售后完成</li>
                        </ul>
            ...
            <div class="z-box">
                <table class="z-tbl">
                    ...
                    <tr>
                        <td><h3 class="h3">以下是你选择售后的商品 </h3>共选择<span style="color: red;">${map.size}</span>种商品，本次售后货品金额总计<span style="color: red;">${map.refundAll}</span>元</td>
                    </tr>
                </table>
                <div class="z-box2">
                    <table class="z-tbl">
            ...
            <div class="z-box">
                ...
                <div style="padding: 0px;" class="bj z-box2">
                    ...
                    <div class="bj-right" >
                        ...
                        <ul>
                            <li><span class="tit" style="width:70px ">快递公司：</span><span>${map.exportName}</span></li>
                            <li><span class="tit" style="width:70px ">快递单号：</span><span>${map.exportNo}</span></li>
                            <li><span class="tit" style="width:70px ">售后原因：</span><span>${map.returnResion}</span></li>
                            <li>
                                <span class="tit" style="width:70px ">需要售后的货品金额：</span>
                                <span style="color: red">${map.refundAll}</span>
                            </li>
                            <li style="word-break:break-all;"><span class="tit" style="width:70px ">售后说明：</span>${map.remark}</li>
                            <li>
