                ...
                success:function(data){
                    ...
                    if(data.success){
                        ...
                        $(data.obj.list).each(function(i,item){
                            ...
                            //        +"</td><td>"+getcode(item.refunfreight)+"</td><td>"+getcode(item.shopName)+"</td>";
                                    
                            html2=html2+"<tr><td>"+num+"</td><td>"+getcode(item.thcode)+"</td><td>"+getcode(item.statename)+"</td><td>"+getcode(item.orderid)+"</td><td>"+getcode(item.buyername)+"</td><td>"+getcode(item.credatedate)+"</td><td>"+getcode(item.refungood)
                                    +"</td><td>"+getcode(item.shopName)+"</td>";
                            if(item.id){
...
<div class="content sub-content">
    <div class="content-body content-sub-body">
        ...
        <form:form id="searchForm" modelAttribute="user" action="${ctx}/customerservice/customerservicelist/" method="post" class="breadcrumb form-search">
        ...
        <table id="contentTable" class="table table-striped table-bordered table-condensed td-cen hhtd">
            ...
            <tr>
                ...
                <th width="14%">申请时间</th>
                <th width="7%">退款金额</th>
                <th width="7%" style="display:none">手续费</th>
                <th width="14%">处理卖家</th>
                <th width="7%">查看详情</th>
            </tr>
            </thead>
            ...
            <c:forEach items="${map.page.list}" var="item" varStatus="s">
                <tr>
                    ...
                    <td style="display:none">${item.factorage}</td>
                    <td>${item.shopName}</td>
                    <td>
