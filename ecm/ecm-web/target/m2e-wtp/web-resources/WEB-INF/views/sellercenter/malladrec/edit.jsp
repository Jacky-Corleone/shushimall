...
<script type="text/javascript">
  ...
  //表单提交
	...
	function changeImgsize(self){
		if(self.value==1){
            $("#imgspan").text("仅支持JPG、JPEG、PNG、BMP格式，大小不得超过1M，建议图片尺寸：290*210");
		}else if(self.value==2){
            $("#imgspan").text("仅支持JPG、JPEG、PNG、BMP格式，大小不得超过1M，建议图片尺寸：293*613");
...
<body>
	<form:form id="inputForm" modelAttribute="dto" action="${ctx}/mallAdRec/edit" method="post" class="form-horizontal">
		<form:hidden path="id"/>
...
<%-- 		<input type="hidden" id="themeId" name="themeId" value="${statusDTO.themeId}"> --%>
			...
			<div class="control-group">
				...
				<div class="controls">
					<label class="lbl" id="theme_label">
						<form:select path="themeId" onchange="onRecSelect(this.value,'${dto.recId }')">
		...
		<div class="control-group">
			...
			<div class="controls">
				<label class="lbl" id="rec_label">
					<form:select path="recId" required="true">
		...
		<div class="control-group">
			...
			<div class="controls">
                ...
                <span id="imgspan" style="color: red">仅支持JPG、JPEG、PNG、BMP格式，大小不得超过1M，建议图片尺寸：290*210</span>
				<span class="z-upload">
