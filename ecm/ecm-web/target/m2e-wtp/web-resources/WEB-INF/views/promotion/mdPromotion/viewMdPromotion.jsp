...
<script type="text/javascript">
	$(document).ready(function() {
		...
		if(${promotion.isAllItem==2}){
			$.ajax({
				url:"${ctx}/mdPromotion/findSelectedMdItem",
	            type:"post",
	            data:{
	            	id:${promotion.id}
	            },
	            ...
	            success:function(data){
	            	...
	            	var i = $("#discountPercentTemp").val();
	            	$("#discountPercent").html(i);
	            }
			});
		}
			...
			<div class="container-fluid">
				<form name="addPromotionForm" modelAttribute="promotion" id="addPromotionForm" action="${ctx}/frPromotion/saveFrPromotion">
	                ...
	                <div class="row-fluid" style="margin-top: 10px">
	                    ...
	                    <div class="span7">所选商品统一享有 <strong> <span id="discountPercent">
	                    ${markDownType==2?promotionPrice:discountPercent}</span></strong>${markDownType==2?'元':'折'}优惠。
	                    </div>
	                </div>
	                <div class="row-fluid" style="margin-top: 10px">
...
<%-- 	                    	<c:if test="${promotion.platformId=='2'}">绿印平台</c:if> --%>
	                    </div>
	                </div>
		            </br>
