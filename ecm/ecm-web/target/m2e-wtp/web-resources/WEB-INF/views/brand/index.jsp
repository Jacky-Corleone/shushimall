...
//		$.jBox.info(brandString);
  ...
  //提交选择的品牌
	...
	function editUpload(){
		var brandName =$('#editBrandName').val();
		var brand=$("#brandId").val();
		var brandLogoUrl = $('#brandLogoUrl').val();
...
<%--	        	<select id="brandSelect"  multiple="multiple" name="brandIds">
				...
				<div class="row-fluid">
	            	<input class="btn" type="button" value="保存品牌" onclick="submitBrandAddSelectForm()" />
					<a class="btn btn-primary" href="javascript:showAddBrandDiv()"><i class="icon-plus"></i>新增品牌</a>
				</div>
				<hr>
				</div>
