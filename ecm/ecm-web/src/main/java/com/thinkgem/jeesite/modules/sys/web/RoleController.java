...
//		model.addAttribute("categoryList", categoryService.findByUser(false, null));
	...
	public String save(Role role, Model model, String oldName, RedirectAttributes redirectAttributes) {
		if(SysProperties.isDemoMode()){
			...
			return "redirect:"+SysProperties.getAdminPath()+"/sys/role/?repage";
		}
...
//			addMessage(redirectAttributes, "删除角色失败, 不能删除当前用户所在角色");
	...
	public String outrole(String userId, String roleId, RedirectAttributes redirectAttributes) {
		if(SysProperties.isDemoMode()){
			addMessage(redirectAttributes, "演示模式，不允许操作！");
			return "redirect:"+SysProperties.getAdminPath()+"/sys/role/assign?id="+roleId;
		}
		...
		return "redirect:"+SysProperties.getAdminPath()+"/sys/role/assign?id="+role.getId();
	}
