...
import com.thinkgem.jeesite.modules.cms.utils.ChineseToPinYinUtil;
...
public class CategoryController extends BaseController {
	 ...
	 */
	@ResponseBody
	@RequestMapping(value = "getStaticPath")
	public String getStaticPath(HttpServletRequest request, HttpServletResponse response) {
		System.out.println("1233333333333333333333333333333333333333");
		String parentId = request.getParameter("parentId");
		String name = request.getParameter("name");
		String path = ChineseToPinYinUtil.converterToFirstSpell(name);
		if(parentId!="0"){
			Category catalog = categoryService.get(parentId);
			path=catalog.getStaticpath()+"/"+path+"/";
		}
