...
<body>
	<form:form id="inputForm" modelAttribute="financeAccountInfoDto" method="post" action="${ctx}/trade/add" class="form-horizontal">
		<div class="control-group">
			<label class="control-label" >金融云支付账号:</label>
			<div class="controls">
				<form:input path="financialCloudPaymentAccountId" htmlEscape="false" maxlength="100" />
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" >全名:</label>
			<div class="controls">
				<form:input path="fullName" htmlEscape="false" maxlength="50" class="required userName" />
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" >所属银行:</label>
			<div class="controls">
				<form:input path="ownedBank" htmlEscape="false" maxlength="50" class="required userName" />
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" >银行登录用户名:</label>
			<div class="controls">
				<form:input path="bankLoginUsername" htmlEscape="false" maxlength="50" class="required userName" />
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" >主账户名称:</label>
			<div class="controls">
				<form:input path="masterAccountName" htmlEscape="false" maxlength="50" class="required userName" />
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" >主账户帐号:</label>
			<div class="controls">
				<form:input path="masterAccountNumber" htmlEscape="false" maxlength="50" class="required userName" />
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" >集群ID:</label>
			<div class="controls">
				<form:input path="clusterId" htmlEscape="false" maxlength="50" class="required userName" />
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" >结算账户名称:</label>
			<div class="controls">
				<form:input path="settlementAccountName" htmlEscape="false" maxlength="50" class="required userName" />
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" >结算账户帐号:</label>
			<div class="controls">
				<form:input path="settlementAccountNumber" htmlEscape="false" maxlength="50" class="required userName" />
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" >佣金账户名称:</label>
			<div class="controls">
				<form:input path="commissionAccountName" htmlEscape="false" maxlength="50" class="required userName" />
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" >佣金账户帐号:</label>
			<div class="controls">
				<form:input path="commissionAccountNumber" htmlEscape="false" maxlength="50" class="required userName" />
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" >代理出金账户名称:</label>
			<div class="controls">
				<form:input path="actingOutGoldAccountName" htmlEscape="false" maxlength="50" class="required userName" />
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" >代理出金账户帐号:</label>
			<div class="controls">
				<form:input path="actingOutGoldAccountNumber" htmlEscape="false" maxlength="50" class="required userName" />
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" >公共计息收费账户名:</label>
			<div class="controls">
				<form:input path="publicChargingFeesAccountName" htmlEscape="false" maxlength="50" class="required userName" />
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" >公共计息收费账户帐号:</label>
			<div class="controls">
				<form:input path="publicChargingFeesAccountNumber" htmlEscape="false" maxlength="50" class="required userName" />
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" >公共调账户名称:</label>
			<div class="controls">
				<form:input path="publicAccountName" htmlEscape="false" maxlength="50" class="required userName" />
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" >公共调账户帐号:</label>
			<div class="controls">
				<form:input path="publicAccountNumber" htmlEscape="false" maxlength="50" class="required userName" />
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" >资金初始化账户名称:</label>
			<div class="controls">
				<form:input path="initializationFundsAccountName" htmlEscape="false" maxlength="50" class="required userName" />
			</div>
		</div>
		<div class="control-group">
			<label class="control-label" >资金初始化账户帐号:</label>
			<div class="controls">
				<form:input path="initializationFundsAccountNumber" htmlEscape="false" maxlength="50" class="required userName" />
			</div>
		</div>
		<div class="control-group">
