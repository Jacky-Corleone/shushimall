...
<head>
	...
	<script type="text/javascript">
		...
		function isShow(idDTO,statusDTO,obj,floorType,addressType,themeId) {
			var url=window.href='${ctx}/mallRec/modifyStatus?idDTO='+idDTO+'&statusDTO='+statusDTO+'&floorType='+floorType+'&addressType='+addressType+'&pageNo='+$("#pageNo").val()+"&themeId="+themeId;
...
<body>
    ...
    <div class="content sub-content">
        <div class="content-body content-sub-body">
        	 ...
        	 <form:form name="searchForm"  modelAttribute="mallRecDTO"  id="searchForm" method="post" class="breadcrumb form-search" action="${ctx}/mallRec/list"  >
                    ...
                    <input id="addressType" name="addressType" type="hidden" value="${addressType}" />
			       		<div class="row-fluid">
			       			<c:if test="${addressType == 1}">
			                    <div class="span4">
			                    	<label class="label-left control-label">子站名称：</label>
						...
						<div class="row-fluid">
							<div class="span3 offset9 text-right">
								<a href="${ctx}/mallRec/form?addressType=${addressType}"
									class="btn btn-primary">添加楼层</a>
							</div>
						</div>
					</form:form>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <td>
                                        ...
                                        <a id="cc" href="javascript:void(0)" onclick="isShow('${mallRecView.mallRec.idDTO}','${mallRecView.mallRec.statusDTO}' ,this,'${mallRecView.mallRec.floorTypeDTO}','${addressType }','${mallRecView.mallRec.themeId }')">${mallRecView.mallRec.statusDTO==1?'下架':'上架'}</a>
