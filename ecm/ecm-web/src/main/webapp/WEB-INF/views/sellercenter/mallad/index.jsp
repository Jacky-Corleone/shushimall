					...
					<input id="pageSize" name="pageSize" type="hidden" value="${page.pageSize}"/>
						...
						<div class="row-fluid" style="margin-top: 10px;">
							<c:if test="${addressType == 1}">
								<div class="span4">
									...
									<form:select path="themeId" cssClass="input-medium">
										...
										<form:options items="${themeList }" itemLabel="themeName"
											itemValue="id" />
									</form:select>
								</div>
							</c:if>
							<div class="span4">
								<label class="label-left control-label" for=adType >类型：</label>
							...
							<div class="span4">
								...
								<form:input path="adTitle" htmlEscape="false" maxlength="50"
						...
						<div class="span7" style="float:right;margin-right:-7px">
