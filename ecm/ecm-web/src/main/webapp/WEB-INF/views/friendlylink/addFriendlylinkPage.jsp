...
var firstLoadShop = true, firstLoadSku =true;
	...
	function saveFrPromotion(){
		...
		$("#linkName").val();
		$("#linkUrl").val();
		$("#addFriendlylinkPageForm").validate({
            rules: {
            	"linkName": "required",
            	"linkUrl": "required"
            }
        });
		var isValide = $("#addFriendlylinkPageForm").valid();
		if(isValide){
			var ids = [];
			
			$("#addFriendlylinkPageForm").submit();
		}else{
			 $("#subId").hideMsg();
		}
	...
	<div class="content sub-content">
		<div class="content-body content-sub-body">
			<div class="container-fluid">
				<form name="addFriendlylinkPageForm" modelAttribute="friendlylinkItem" method="post" id="addFriendlylinkPageForm" action="${ctx}/friendlylink/savefriendlylinkpage" >
	                <legend ><span class="content-body-bg">基本信息</span></legend>
	                <input name="id" id="id" maxlength="50"  value="${friendlylinkPageDB.id}"  type="hidden" class="form-control"/>
	                 <div class="row-fluid" style="margin-top: 10px">
	                    <div class="span1">页面名称：</div>
	                    <div class="span7">
	                        <input name="pageName" id="pageName" maxlength="100" type="text" value="${friendlylinkPageDB.pageName}" class="form-control" title="请输入页面名称"/>
	                    </div>
	                </div>
	                <div class="row-fluid" style="margin-top: 10px">
	                    <div class="span1">页面URL：</div>
	                    <div class="span7">
	                        <input name="pageUrl" id="pagekUrl" maxlength="20" type="text" value="${friendlylinkPageDB.pageUrl}" class="form-control" title="请输入页面URL"/>
	                    </div>
	                </div>
