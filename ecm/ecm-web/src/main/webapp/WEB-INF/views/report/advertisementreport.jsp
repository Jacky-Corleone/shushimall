            ...
            <div class="row-fluid">
			    ...
			    <label class="label-left control-label">广告类型：</label>
				 <select id="type" name="mallAdType">
					  ...
					  <option value="5"  <c:if test="${5 eq mallAdCountDTO.mallAdType}">selected</c:if>>推荐服务</option>
					  <option value="6"  <c:if test="${6 eq mallAdCountDTO.mallAdType}">selected</c:if>>推荐套餐</option>
					  <option value="7"  <c:if test="${7 eq mallAdCountDTO.mallAdType}">selected</c:if>>在线轻松购</option>
					  <option value="11"  <c:if test="${11 eq mallAdCountDTO.mallAdType}">selected</c:if>>底部广告</option>
	             </select>
               </div>
               </div>
            ...
            <c:forEach items="${page.list}" var="user">
                <tr>
                    ...
                    <c:if test="${6 eq user.AdType}">
                     ...
                     <c:if test="${7 eq user.AdType}">
                                                           在线轻松购
                    </c:if>
                    <c:if test="${11 eq user.AdType}">
                                                           底部广告
                    </c:if>
                    </td>
                    <td>
