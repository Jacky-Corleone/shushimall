...
<!-- 						<input type="radio" name="platformId" value="2" id="platformId2"><label for="platformId2">上海绿印中心</label> -->
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<label style="color: red">仅支持JPG、JPEG、PNG、BMP格式，大小不得超过1M，建议图片尺寸：310*62</label>
				...
				<a class="button_4 hei_32" href="javascript:uploadImg('picUrlImg','picUrl')" > 浏览图片 </a>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">图片预览:</label>
			<span style="color: red">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;建议图片尺寸:310*62</span>
			<div class="controls">
