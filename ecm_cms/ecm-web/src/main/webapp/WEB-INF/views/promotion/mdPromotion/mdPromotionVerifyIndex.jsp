	...
	function updateStateAjax(id,onlineState,auditDismissedMsg){
		$.ajax({
            ...
            data:{
            	...
            	auditDismissedMsg:auditDismissedMsg
            },
            dataType:'json',
            success:function(data){
            	if(data.success){
            		location.href ="${ctx}/mdPromotion/mdPromotionVerifyIndex";
            	}
            }
        });
	}
	...
	<div class="content sub-content">
		<div class="content-body content-sub-body">
			<div class="container-fluid">
				<div class="row-fluid">
					<form:form id="searchForm" modelAttribute="promotionInfo" action="${ctx}/mdPromotion/mdPromotionVerifyIndex" method="post" class="breadcrumb form-search">
						...
						<div class="row-fluid" style="margin-top: 10px;">
							...
							<div class="span2">
	                			<input type="submit" class="btn btn-primary"  onclick="javascript:searchPromotionVerify()" value="搜索">
							</div>
							<%-- <div class="span4">
