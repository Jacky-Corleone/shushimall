...
<script type="text/javascript">
	...
	function editPromotion(id){
	    var url="${ctx}/frPromotion/editFrPromotion?id="+id;
	    var title = "编辑满减活动";
	    parent.openTab(url,title,"ge"+id);
	}
	function deletePromotion(id){
		top.$.jBox.confirm("确认要删除吗？","系统提示",function(v,h,f){
            if(v == "ok"){
            	$.ajax({
                    url:"${ctx}/frPromotion/deleteFrPromotion",
                    type:"post",
                    data:{
                    	id:id
                    },
                    ...
                    success:function(data){
                    	if(data.success){
                    		location.href ="${ctx}/frPromotion/frPromotionIndex";
                    	}
                    }
                });
            }
	...
	<div class="content sub-content">
		<div class="content-body content-sub-body">
			<div class="container-fluid">
				<div class="row-fluid">
					<form:form id="searchForm" modelAttribute="promotionInfo" action="${ctx}/frPromotion/frPromotionIndex" method="post" class="breadcrumb form-search">
