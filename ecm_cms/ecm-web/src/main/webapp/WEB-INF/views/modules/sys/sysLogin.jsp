...
<section class="section" style="margin-top: 6%;">
    <div class="container">
        <div class="signin-form row-fluid" >
            <div class="span1"></div>
            <!--Sign In-->
            <div class="span7"> <img src="${ctxStatic}/images/loginimg.jpg" style="height: 266px"/></div>
            <div class="span3">
                <div class="box corner-all" >
                    <div class="box-header grd-teal color-white corner-top">
                        <span style="font-family: '微软雅黑'; font-size: 14px; color:#FFFFFF;">舒适100管理平台</span>
                    </div>
...
舒适100字体由汉仪字库提供    Tel：400-9987-466    E-mail：server@shushi100.com</p>
</footer>
