                ...
                <div class="row-fluid">
                    ...
                    <div class="span4">
                        ...
                        <select name="state" id="state" class="input-medium">
                            ...
                            <option value="2" <c:if test="${orderQuery.state==2}">selected="selected" </c:if>>待配送</option>
                            <option value="3" <c:if test="${orderQuery.state==3}">selected="selected" </c:if>>待确认送货</option>
                ...
                <tr id="tr${t.orderId}">
                    ...
                    <td>
                        <c:choose>
                            ...
                            <c:when test="${t.state==2}">待配送</c:when>
                            <c:when test="${t.state==3}">待确认送货</c:when>
