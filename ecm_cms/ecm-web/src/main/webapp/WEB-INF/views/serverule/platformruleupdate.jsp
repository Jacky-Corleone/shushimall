            ...
            <div class="y-box">
                ...
                <div class="bd">
                    <div class="z-item">
                        ...
                        <div class="z-bd">
                            <div id="fileinputid" class="preview-pic">
                                <img class="showimg" src="${filePath}${map.ruleUrl}" style="width: 68px;height: 68px;">
                            </div>
                            <input name="fileurl" id="fileurlid" value="${map.ruleUrl}" hidden="hidden">
                            <a class="btn" href="javascript:addPic()"><i class="icon-plus"></i>添加图片</a>
                            <label>单张图片不能大于500K;允许的图片格式有jpg、jpeg、png、JPG、JPEG、PNG</label>
                        </div>
                    </div>
                    <div class="z-item">
                        <div class="z-tt">
                        ...
                        <div style="display:inline-block;overflow:hidden;color:#666;height:50px;">
                            <select name="mallType" id="mallType" style="width: 140px;" onchange="docname()" class="required">
                                ...
                                <c:forEach items="${map.typeList}" var="typeVal">
                                    <c:forEach var="entry" items="${typeVal}">
                                        <c:if test="${map.classfytype==entry.key}">
                            ...
                            <select name="lx" id="lx" style="width:140px;" onchange="lxofmx()">
                                ...
                                <c:forEach items="${map.list}" var="item">
                                    <c:if test="${item.id==map.docclassid}">
                            ...
                            <select name="mx" id="mx" style="width:140px;" >
                                ...
                                <c:forEach items="${map.listMxMap}" var="item">
                                    <c:if test="${item.code==map.docid}">
