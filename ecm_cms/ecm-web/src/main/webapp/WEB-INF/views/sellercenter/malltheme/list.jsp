...
<meta name="decorator" content="default"/>
	...
	<script type="text/javascript">
		...
		function todelete(id){
			...
			// 自定义按钮  
			$.jBox.confirm("频道包含广告、楼层、公告等信息，确定要删除频道吗？", "提示", submit, { buttons: { '确定': true, '取消': false} }); 
		}
