                ...
                success:function(data){
                    ...
                    if(data.success){
                        ...
                        $(data.obj.list).each(function(i,item){
                            ...
                            html2 = html2+ "<td>"+getcode(item.zflx)+"</td><td>"+getcode(item.promocode)+"</td><td>"+getcode(item.ordertime)+"</td><td>"+getcode(item.address)+"</td>"
                            ...
                            if(item.id){
                                html2=html2+"<td><a href='javascript:void(0)' onclick='salesdetail(\""+item.id+"\")'>明细<a></td>"
                            }else{
                                html2=html2+"<td></td>"
                            }
                            html2=html2+"</tr>";
