...
<script src="${ctxStatic}/My97DatePicker/lang/zh-cn.js" type="text/javascript"></script>
...
<script src="${ctxStatic}/ajaxfileupload.js" type="text/javascript"></script>
<script src="${ctxStatic}/camelot.js" type="text/javascript"></script>
<script  src="${ctxStatic}/jquery-fancyzoom/jquery.shadow.js"></script>
<script  src="${ctxStatic}/jquery-fancyzoom/jquery.ifixpng.js"></script>
<script  src="${ctxStatic}/jquery-fancyzoom/jquery.fancyzoom.js"></script>
<style>
   *{
        font-family: "微软雅黑"; font-size: 12px; color:#000000;
    }
    table th{
        font-size:1.1em;
        text-align:left;
