...
public class ItemDTO implements Serializable {
	...
	private List<SellPrice> sellPrices = new ArrayList<SellPrice>();//商品阶梯价格 平台:非必填；商家:必填      
	private List<SkuInfo> skuInfos = new ArrayList<SkuInfo>();//SKU列表 平台:非必填；商家:必填      
	private List<ItemAttr> attrSale = new ArrayList<ItemAttr>();//销售属性 平台:非必填；商家:必填  也可以查询作为查询条件用
	private List<ItemAttr> attributes = new ArrayList<ItemAttr>();//商品非销售属性 平台:必填；商家:必填 也可以查询作为查询条件用
	private List<ItemShopCartDTO> itemShopCartDTOs = new ArrayList<ItemShopCartDTO>();//SKU信息
	private List<ItemSkuPackageDTO> itemSkuPackageDTOs=new ArrayList<ItemSkuPackageDTO>();//套装商品关联关系表
	...
	private String specification;//  商品描述url，存在jfs中  平台:必填；商家:必填   
	private String housetype; // 11 一室一厅 21两室一厅 31三室一厅
	private String subNum;//组合商品选择商品的数量
	...
	public List<ItemShopCartDTO> getItemShopCartDTOs() {
		return itemShopCartDTOs;
	}

	public void setItemShopCartDTOs(List<ItemShopCartDTO> itemShopCartDTOs) {
		this.itemShopCartDTOs = itemShopCartDTOs;
	}

	public List<ItemSkuPackageDTO> getItemSkuPackageDTOs() {
		return itemSkuPackageDTOs;
	}

	public void setItemSkuPackageDTOs(List<ItemSkuPackageDTO> itemSkuPackageDTOs) {
		this.itemSkuPackageDTOs = itemSkuPackageDTOs;
	}
