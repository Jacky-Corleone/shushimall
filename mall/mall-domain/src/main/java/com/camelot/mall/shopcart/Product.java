...
public class Product implements java.io.Serializable {
	private static final long serialVersionUID = 8325508608392511040L;
    ...
    //  1：普通商品 2：平台上传 3：套装商品 4：基础服务商品 5：增值服务商品 6：辅助材料商品
    ...
    private List<Product> valueAddedProducts = new ArrayList<Product>();//套装商品增值服务信息
    private List<Product> subProducts = new ArrayList<Product>();//套装商品的单品信息
    private List<Product> auxiliaryProducts = new ArrayList<Product>();//套装商品的辅料信息
    private List<Product> basicProducts = new ArrayList<Product>();//套装商品的基础服务信息
    private List<Product> showBasicProducts = new ArrayList<Product>();//套装商品的基础服务信息(在购物车和订单核对页展示用)
    private List<Product> showAuxiliaryProducts = new ArrayList<Product>();//套装商品的辅料信息(在购物车和订单核对页展示用)
	...
	public List<Product> getValueAddedProducts() {
		return valueAddedProducts;
	}

	public void setValueAddedProducts(List<Product> valueAddedProducts) {
		this.valueAddedProducts = valueAddedProducts;
	}

	public List<Product> getAuxiliaryProducts() {
		return auxiliaryProducts;
	}

	public void setAuxiliaryProducts(List<Product> auxiliaryProducts) {
	...
	public void setBasicProducts(List<Product> basicProducts) {
		this.basicProducts = basicProducts;
	}

	public List<Product> getShowBasicProducts() {
		return showBasicProducts;
	}

	public void setShowBasicProducts(List<Product> showBasicProducts) {
		this.showBasicProducts = showBasicProducts;
	}

	public List<Product> getShowAuxiliaryProducts() {
		return showAuxiliaryProducts;
	}

	public void setShowAuxiliaryProducts(List<Product> showAuxiliaryProducts) {
