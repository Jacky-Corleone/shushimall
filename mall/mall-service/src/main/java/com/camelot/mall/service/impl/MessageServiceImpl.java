...
public class MessageServiceImpl implements MessageService {
	...
	public ExecuteResult<String> sendSms(String telephone, String content) {
		...
		try {
			...
			String msgSoapaddress = smsConfig.getMsgSoapaddress();
			int resultCode = SingletonClient.getClient(msgSoapaddress, softwareSerialNo, key).sendSMS(new String[] { telephone },
					content, "", 5);
    ...
    public static void main(String[] args){
    	try {
    		//System.out.println(SingletonClient.getClient("3SDK-EMY-0130-QCUST","c2h1c2hpMTAw").registEx("c2h1c2hpMTAw"));
			...
			int i = SingletonClient.getClient("http://sdkhttp.eucp.b2m.cn:8080/sdk/SDKService?wsdl", "3SDK-EMY-0130-QCUST","c2h1c2hpMTAw").sendSMS(new String[] { "13501133340" }, "【舒适100】尊敬的用户,您的手机验证码是8541,网上学知识看工程,价格公正透明轻松选购,回复TD退订", "",5);// 带扩展码
