...
import com.camelot.mall.util.emay.sdkhttp.Mo;
import com.camelot.mall.util.emay.sdkhttp.SDKServiceBindingStub;
import com.camelot.mall.util.emay.sdkhttp.SDKServiceLocator;
import com.camelot.mall.util.emay.sdkhttp.StatusReport;
...
public class EmayClient {
	...
	public EmayClient(String sdkServiceAddress, String sn, String key) {
		this.softwareSerialNo = sn;
		this.key = key;
		this.sdkServiceAddress = sdkServiceAddress;
		init();
	}
	...
	public void init() {
		try {
			binding = (SDKServiceBindingStub) new SDKServiceLocator(sdkServiceAddress).getSDKService();
