...
public class SDKClientProxy implements com.camelot.mall.util.emay.sdkhttp.SDKClient {
  private String _endpoint = null;
  private com.camelot.mall.util.emay.sdkhttp.SDKClient sDKClient = null;
  ...
  private void _initSDKClientProxy() {
    try {
      sDKClient = (new com.camelot.mall.util.emay.sdkhttp.SDKServiceLocator()).getSDKService();
      if (sDKClient != null) {
        if (_endpoint != null)
  ...
  public com.camelot.mall.util.emay.sdkhttp.SDKClient getSDKClient() {
    if (sDKClient == null)
      _initSDKClientProxy();
    return sDKClient;
  }
