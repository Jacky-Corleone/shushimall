 ...
 * 
 */
public class CiticPayJournal  implements Serializable {
	...
	private java.lang.String statusText;//  交易结果
	private java.lang.Integer payType;//  交易类型  0支付/1结算/2提现/3退款
	@PropertyMapping("enableFlag")
	private java.lang.Integer enableFlag;//  是否有效 0无效/1有效
	@PropertyMapping("dealFlag")
	private java.lang.String dealFlag;//  处理标记 
	@PropertyMapping("dealText")
	private java.lang.String dealText;//  中信查询处理结果
