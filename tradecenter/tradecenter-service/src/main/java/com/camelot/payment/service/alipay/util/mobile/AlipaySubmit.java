...
import com.camelot.payment.service.alipay.util.mobile.httpClient.HttpProtocolHandler;
import com.camelot.payment.service.alipay.util.mobile.httpClient.HttpRequest;
import com.camelot.payment.service.alipay.util.mobile.httpClient.HttpResponse;
import com.camelot.payment.service.alipay.util.mobile.httpClient.HttpResultType;
...
public class AlipaySubmit {
	...
	public static String buildRequestMysign(Map<String, String> sPara) {
        ...
        if(AlipayConfig.SIGN_TYPE.equals("MD5") ) {
        	mysign = MD5.sign(prestr, AlipayConfig.KEY_MOBILE, AlipayConfig.INPUT_CHARSET);
        }
    ...
    public static String buildRequest(String ALIPAY_GATEWAY_NEW, Map<String, String> sParaTemp, String strMethod, String strButtonName, String strParaFileName) {
        ...
        sbHtml.append("<form id=\"form\" name=\"alipaysubmit\"  enctype=\"multipart/form-data\" action=\"" + ALIPAY_GATEWAY_NEW
                      + "_input_charset=" + AlipayConfig.INPUT_CHARSET + "\" method=\"" + strMethod
                      + "\">");
    ...
    public static String getRequestToken(String text) throws Exception {
    	...
    	if (paraText.get("res_data") != null) {
    		...
    		xstream.processAnnotations(AlipayMRes.class);	
    		AlipayMRes s=(AlipayMRes)xstream.fromXML(res_data);
    		request_token =s.getRequest_token();
...
//    		request_token = document.selectSingleNode( "//direct_trade_create_res/request_token" ).getText();
	...
	public static String query_timestamp() throws MalformedURLException,
        ...
        String strUrl = "https://mapi.alipay.com/gateway.do?service=query_timestamp&partner=" + AlipayConfig.PARTNER_MOBILE;
