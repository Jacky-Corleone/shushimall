...
public class AlipayNotify {
    ...
    public static boolean verifyReturn(Map<String, String> params) {
	    ...
	    logger.error("++++sWord+++verifyReturn++++" + sWord);
    ...
    public static boolean verifyNotify(Map<String, String> params) throws Exception {
	    ...
	    logger.error("+++++++++sWord++++++verifyNotify++" + sWord);
	...
	private static boolean getSignVeryfy(Map<String, String> Params, String sign, boolean isSort) {
        ...
        logger.error("++++++++++++++++MD5+++++++++++++++++"+preSignStr);
        //获得签名验证结果
        boolean isSign = false;
        if(AlipayConfig.SIGN_TYPE.equals("MD5") ) {
        	isSign = MD5.verify(preSignStr, sign, AlipayConfig.KEY_MOBILE, AlipayConfig.INPUT_CHARSET);
        }
        if(AlipayConfig.SIGN_TYPE.equals("0001")){
        	isSign = false;//RSA.verify(preSignStr, sign, AlipayConfig.ali_public_key, AlipayConfig.INPUT_CHARSET);
        }
        return isSign;
    }
    ...
    */
    private static String verifyResponse(String notify_id) {
        ...
        String partner = AlipayConfig.PARTNER_MOBILE;
