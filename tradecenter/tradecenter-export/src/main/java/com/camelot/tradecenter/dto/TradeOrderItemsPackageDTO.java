...
/**
 * 
 * <p>Description: [套装商品订单记录表]</p>
 * Created on 2016年2月25日
 * @author  <a href="mailto: songwenbin@camelotchina.com">宋文斌</a>
 * @version 1.0 
 * Copyright (c) 2016 北京柯莱特科技有限公司 交付部
 */
public class TradeOrderItemsPackageDTO implements Serializable {
	...
	private List<Integer> subNums;//套装单品/服务数量数组集合
	private List<Integer> addSources;//商品来源集合字段
	...
	public List<Integer> getSubNums() {
		return subNums;
	}

	public void setSubNums(List<Integer> subNums) {
