package com.camelot.pricecenter.dto.indto;
 ...
 */
public class ProductInPriceDTO implements Serializable {
    ...
    private Integer platFormId;	// 标识是绿印还是科印   (1:科印，2：绿印)
    //活动明细对象
    private TradeOrderItemsDiscountDTO tradeOrderItemsDiscountDTO;
    ...
    private List<ProductInPriceDTO> valueAddedProducts = new ArrayList<ProductInPriceDTO>();//套装商品增值服务信息
    private List<ProductInPriceDTO> subProducts = new ArrayList<ProductInPriceDTO>();//套装商品的单品信息
	...
	public TradeOrderItemsDiscountDTO getTradeOrderItemsDiscountDTO() {
	...
	public List<ProductInPriceDTO> getSubProducts() {
		return subProducts;
	}

	public void setSubProducts(List<ProductInPriceDTO> subProducts) {
		this.subProducts = subProducts;
	}

	public List<ProductInPriceDTO> getValueAddedProducts() {
		return valueAddedProducts;
	}

	public void setValueAddedProducts(List<ProductInPriceDTO> valueAddedProducts) {
