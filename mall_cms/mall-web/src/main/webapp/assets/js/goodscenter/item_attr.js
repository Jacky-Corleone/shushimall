			...
			$.each(data.result, function (n, pf) {
				if(!plstItemId || itemId){
					if(addSource==3){
						...
						html+="数量"+"<input type=\"text\" id='"+itemId+"' onkeyup=\"numInput(this)\" name=\"sub_num\" value='"+count+"' class=\"input_Style2 hei_24 wid_30 mar_l10\">";
						html+="</div>";
					}else{
...
function createServceHtml(sellAttrOneMap,sellSkuAttrMap,sellmap,itemName,itemId,jsonobj,skuInfo,type,baseAddService,selectBaseItemId,lists){
    ...
    if(isView){
    	...
    	html+="<span class=\"over_attr_val cursor\" >"+itemName+"</span>"+"&nbsp;&nbsp;";
    	html+="数量"+"<input type=\"text\" readonly=\"readonly\" onkeyup=\"numInput(this)\" value='"+num+"'  class=\"sub_num input_Style2 hei_24 wid_30 mar_l10\" >";
    	html+="</div>";
    }else{
    	html+="<div class=\"mar_r20 fl\" >";
    	html+="<span class=\"over_attr_val cursor\" >"+itemName+"</span>"+"&nbsp;&nbsp;";
    	if(baseAddService=='valueaddId'){
    		 ...
    		 html+="数量"+"<input type=\"text\" onkeyup=\"numInput(this)\" value='"+num+"' class=\"sub_num input_Style2 hei_24 wid_30 mar_l10\">"+"&nbsp;&nbsp;"+"<a class='cursor' style='color:red' onclick=\"deleteChar(this,'"+selectBaseItemId+"')\">删除</a>";
    	}
    	html+="</div>";
    }
