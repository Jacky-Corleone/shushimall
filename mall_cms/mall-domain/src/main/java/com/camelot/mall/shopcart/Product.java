...
public class Product implements java.io.Serializable {
	...
	private Integer unusualState; // null: 正常商品或商品未选中； 1：商品已下架；2：不符合店铺规则, 3：库存不足, 4: 商品暂无报价！,5：集采商品不能和正常商品一起结算，6该集采商品不存在,7该集采商品不在活动有效期之内,8集采数量超过了每个用户可购买的最大数量,9超过了每个用户可购买的最大限制 10 买家不能购买自己店铺的商品 11抱歉！该套装中存在非在售的组合单品，暂时不能购买 12 抱歉！该套装中存在非销售的组合单品，暂时不能购买。
